...
if(isset($_POST['submit']))
  {
    ...
    //Query for data updation
     $query=mysqli_query($con, "update  tblusers set FirstName='$fname',LastName='$lname', MobileNumber='$contno', Email='$email', Address='$add', Course='$course' where ID='$eid'");
...
?>
		...
		<div class="form-group">
            <textarea class="form-control" name="course" required="true"><?php  echo $row['Course'];?></textarea>
        </div>     
      <?php 
}?>
		<div class="form-group">
