...
if(isset($_POST['submit']))
  ...
  // Query for data insertion
     $query=mysqli_query($con, "insert into tblusers(FirstName,LastName, MobileNumber, Email, Address, Course) value('$fname','$lname', '$contno', '$email', '$add', '$course' )");
    if ($query) {
...
<div class="signup-form">
    <form  method="POST">
		...
		<div class="form-group">
            <textarea class="form-control" name="course" placeholder="Enter Your Course" required="true"></textarea>
        </div>
